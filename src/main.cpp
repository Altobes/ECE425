...
const int PAUSE_TIME = 2500;         //time before robot moves
const int STEP_TIME = 500;           //delay time between high and low on step pin
const int WAIT_TIME = 15000;         //delay for printing data
